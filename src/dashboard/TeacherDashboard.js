...
// const [state, setState] = useState();
  ...
  return (
    <div className={classes.root}>
      ...
      >
        <Toolbar>
         <img src="Images/logo.png" alt="Kids Galaxy" style={{height: "auto", width: "180px"}}/>
                  <IconButton
                  color="inherit"
                ...
                <div className="appBar__links">
                  ...
                  <FullscreenIcon className="screen" color="#fff" fontSize="medium"/>
                </div>
      ...
      >
        ...
        <List>
            <ListItem>
              <ListItemIcon><FormatAlignCenterOutlinedIcon /></ListItemIcon>
