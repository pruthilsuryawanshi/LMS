...
const TeacherLogin = () => {  
  ...
  function handleSubmit(e){
    ...
    if(validateEmail(email) === null){
      ...
      axios.post("http://127.0.0.1:8000/api/teacher/api/token/",{
          ...
          <form>
            ...
            <div className="input-group mb-3">
              <TextField
                ...
                required
                id="email"
                helperText={first && validateEmail(email)} onBlur={() =>  setFirst(true)}  onFocus={()=> setFirst(false)} value={email} onChange={(e) => setEmail(e.target.value) }             
